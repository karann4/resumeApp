...
import { AppBar, Toolbar, ListItemIcon, ListItem, Icon, ListItemText, Avatar, Divider, List, Typography, Box, IconButton, MenuItem} from '@material-ui/core'
...
const NavBar = () => {
    ...
    const sideList = slider => (
        ...
        <Avatar className={classes.avatar} src={avatar} alt="Slark"/>
        <Divider/>
        <List>
